...
**Collection status:** Draft v0.1

| Kingdom | Biome | Draft animals | Document |
|---|---|---|---|
...
| The High Kingdom | Alpine | Snow Leopard, Golden Eagle, Ibex, Yak, Bearded Vulture, Red Panda | [Read](alpine.md) |
| The Drowned Court | Wetland | Crocodile, Heron, Python, Capybara, Giant River Otter, Kingfisher | [Read](wetland.md) |

ก่อนยกระดับ kingdom ใดเป็น `Review` ให้กรอก schema ใน [Kingdom Template](../../templates/kingdom-template.md) ให้ครบ
